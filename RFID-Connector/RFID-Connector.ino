...
void handleConfig() {
  if (server.args() > 0) {
    ...
    server.send(200, "text/html", "<!DOCTYPE html><html><head><title>RFID-Connector</title></head><body><h1>Configuration saved!</h1><p>You will be redirected in 2 seconds.</p><script>setTimeout(function() { window.location.href = 'http://" + config_wifi_hostname + "'; }, 2000);</script></body></html>");
    wait(500);
    ...
    server.send(200, "text/html", "<!DOCTYPE html><html><head><title>RFID-Connector</title></head><body><h1>Invalid request!</h1><p>You will be redirected in 2 seconds.</p><script>setTimeout(function() { window.location.href = 'http://" + config_wifi_hostname + "'; }, 2000);</script></body></html>");
  }
}
