...
RFID-SmartRace ermöglicht eine Zeitnahme für z.B. Carrera Hybrid oder Dr!vt von Strumkind usw. mit <a href="https://www.smartrace.de/">SmartRace</a>. Hierzu wird der analoge Sensormodus von SmartRace genutzt. Die Anbindung erfolgt über WLAN. Die Zeitnahme ist aktuell für 6 Autos möglich. (6 controller in SmartRace)
Des Weiteren könne 2 RFID-Ids für einen Controller definiert werden. Somit sind auch Langstreckenrennen mit jeweils zwei Fahrzeugen pro Team möglich.
...
Neben SSID und Passwort des zu verwendenen Routers muss die IP-Addresse und der Port des SmartRace-Servers für den analogen Sensorbetrieb gesetzt werden.
