...
#define NUM_LEDS 20
#define LED_ROWS 4
#define COUNTDOWN_TIME_SMARTRACE 5000
#define COUNTDOWN_TIME_CH_RACING_CLUB 5000

#define FLASH_INTERVAL_SMARTRACE 500
#define FLASH_INTERVAL_CH_RACING_CLUB 500
